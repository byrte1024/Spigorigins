...
public class BlazeBorn extends Origin {
    public BlazeBorn(){
        super("BlazeBorn","BLAZE","The flaming creatures of the nether.", Arrays.asList(new String[]{"Does not burn","Cannot be poisoned"}), Arrays.asList(new String[]{"Takes damage in water"}), Material.BLAZE_POWDER,' ');
    }
